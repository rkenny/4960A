...
class Datasets():
    def __init__(self, conf):
        ...
        self.train_loader = DataLoader(self.bundle_train_data, batch_size=batch_size_train, shuffle=True, num_workers=2, drop_last=True) # changed workers from 10 to 2
        self.val_loader = DataLoader(self.bundle_val_data, batch_size=batch_size_test, shuffle=False, num_workers=2) # changed workers from 20 to 2
        self.test_loader = DataLoader(self.bundle_test_data, batch_size=batch_size_test, shuffle=False, num_workers=2) # changed workers from 20 to 2
