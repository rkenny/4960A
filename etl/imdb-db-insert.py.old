...
def main():
  ...
  Verbose = True
  indexes = pickle.load(open("/mnt/b_4960/Data/imdb/title.basics.tsv/indexes.pkl", "rb"))
  teamsVecs = pickle.load(open("/mnt/b_4960/Data/imdb/title.basics.tsv/teams.pkl", "rb"))
